...
// Preload header image for better LCP
const preloadHeaderImage = () => {
  if (typeof window !== "undefined") {
    const imgPreload = new Image();
    imgPreload.src = headerImage;
    return imgPreload;
  }
  return null;
};
...
const HomeComponent = () => {
  ...
  useEffect(() => {
    ...
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => loadLatestBlogs(), { timeout: 2000 });
    } else {
      setTimeout(loadLatestBlogs, 100);
    }
  }, [loadLatestBlogs]);

  // Core values data - extract from JSX to improve readability
  const coreValues = [
  ...
  return (
    <div className="hmc-container">
      <header className="hmc-header">
        ...
        <a href="#main" className="h-arrow-c" aria-label="Scroll to main content">
