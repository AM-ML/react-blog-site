    ...
    const getAuthor = async () => {
      ...
      try {
        const response = await axios.post(
          import.meta.env.VITE_SERVER_DOMAIN + "/get-author",
          {
          ...
          <div className="ac-profile">
            <div className="ac-profile-row">
              ...
              <div className="ac-profile-col">
                ...
                <span className="ac-profile-blogs-count">
                  {author.total_posts} Blogs - Joined At {formattedDate}
                </span>
                <div className="ac-profile-socials">
                  {author.social_links && author.social_links.linkedin && (
                    <a
                      target="_blank"
                  ...
                  {author.social_links && author.social_links.facebook && (
                    <a
                      target="_blank"
                  ...
                  {author.social_links && author.social_links.instagram && (
                    <a
                      target="_blank"
                  ...
                  {author.social_links && author.social_links.twitter && (
                    <a
                      target="_blank"
            ...
            <span className="ac-profile-bio">
              {author.bio.length ? `"${author.bio}"` : "No Bio."}
            </span>
