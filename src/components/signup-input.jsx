  ...
  return (
    <div className="signup-form-container">
      <form ref={form} onSubmit={handleSubmit} className="signup-form">
        <h3 className="signup-title text-bold text-google mt-3">Sign Up</h3>
        <Toaster />
        ...
        <div className="input-group mt-2">
          ...
          <input
            ...
            placeholder="Email"
            name="email"
            id="signup-username signup-email"
            required
          />
        </div>
        ...
        <button className="signup-button" style={{ marginTop: "10%" }}>
          Sign Up
        </button>
        <button
          onClick={googleAuthFunc}
          type="button"
          className="signup-with-google-btn"
        >
          Continue with Google
        </button>
        <p className="mt-3 text-sm">
          Already have an account?{" "}
          <Link to="/signin" className="auth-link text-primary">
            Sign In
          </Link>
        </p>
      </form>
